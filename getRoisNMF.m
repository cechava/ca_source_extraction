...
nmfstruct.source = source_dir;
nmfstruct.tiffPath = tif_path;
nmfstruct.tiffName = tif_name;
nmfstruct.rois = A_or;
nmfstruct.correlation = Cn;
nmfstruct.info = json_file;
nmfstruct.options = options;
nmfstruct.preprocessing.scaleFOV = scaleFOV;
nmfstruct.preprocessing.removeBadFrame = removeBadFrames;
if removeBadFrames
    nmfstruct.preprocessing.refframe = refframe;
    nmfstruct.preprocessing.badframes = badframes;
    nmfstruct.preprocessing.corrcoeffs = corrs;
